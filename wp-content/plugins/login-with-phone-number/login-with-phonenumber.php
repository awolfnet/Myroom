...
require 'gateways/class-lwp-fortdigital-api.php';
...
?>
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input type="text" step="1" id="phone_number" name="phone_number" value="<?php echo esc_attr($phn); ?>" class="regular-text" />
    ...
    function admin_init()
    {
        ...
        add_settings_field('idehweb_fortdigital_user', __('Fortdigital user', $this->textdomain), array(&$this, 'setting_fortdigital_user'), 'idehweb-lwp', 'idehweb-lwp', ['label_for' => '', 'class' => 'ilwplabel related_to_fortdigital']);
        add_settings_field('idehweb_fortdigital_password', __('Fortdigital password', $this->textdomain), array(&$this, 'setting_fortdigital_password'), 'idehweb-lwp', 'idehweb-lwp', ['label_for' => '', 'class' => 'ilwplabel related_to_fortdigital']);
        add_settings_field('idehweb_fortdigital_sender', __('Fortdigital sender', $this->textdomain), array(&$this, 'setting_fortdigital_sender'), 'idehweb-lwp', 'idehweb-lwp', ['label_for' => '', 'class' => 'ilwplabel related_to_fortdigital']);
        ...
        <div class="wrap">
            <div class="lwp-wrap-left">
                ...
                <form action="options.php" method="post" id="iuytfrdghj">
                    ...
                    <p class="submit">
                        ...
                        //                    }else{
                        ?>
                        <input type="submit" class="button-primary" value="<?php _e('Save Changes', $this->textdomain); ?>" />
                    </p>
                    <!--            --><?php //}
                                        ?>
                    <?php
            ...
            <script>
                ...
                jQuery(function($) {
                    ...
                    var related_to_fortdigital = $('.related_to_fortdigital');
                    ...
                    if (edf4.val() == 'fortdigital' && edf3.is(':checked')) {
                        // console.log('is checked!');
                        // $("#idehweb_phone_number_ccode").chosen();
                        related_to_fortdigital.css('display', 'table-row');


                    } else {
                        // console.log('is not checked!');
                        related_to_fortdigital.css('display', 'none');
                    ...
                    $('#idehweb_default_gateways').on('change', function(e) {
                        ...
                        } else if (this.value == "fortdigital" && edf3.is(':checked')) {
                            related_to_customgateway.css('display', 'none');
                            related_to_twilio.css('display', 'none');
                            related_to_zenziva.css('display', 'none');
                            related_to_firebase.css('display', 'none');
                    ...
                    idehweb_body.on('click', '.loiuyt',
                        function() {
                            ...
                            $.ajax({
                                ...
                                url: ajaxurl,
                                data: {
                                    action: 'idehweb_lwp_check_credit'
                                }
                            }).done(function(msg) {
                        ...
                        function() {
                            ...
                            if (lwp_phone_number && lwp_secod && idehweb_phone_number_ccode) {
                                ...
                                $.ajax({
                                    ...
                                    url: ajaxurl,
                                    data: {
                                        action: 'idehweb_lwp_activate_customer',
                                        phone_number: lwp_phone_number,
                                        secod: lwp_secod
                                    }
                                }).done(function(msg) {
    ...
    function setting_default_gateways()
    {
        ...
        $gateways = [
            ...
            ["value" => "fortdigital", "label" => "Fortdigital (Singapore)"]
        ];
    ...
    /**
     * Fortdigital SMS Gateway
     */

    function setting_fortdigital_user()
    {

        $options = get_option('idehweb_lwp_settings');
        if (!isset($options['idehweb_fortdigital_user'])) $options['idehweb_fortdigital_user'] = '';

        echo '<input type="text" name="idehweb_lwp_settings[idehweb_fortdigital_user]" class="regular-text" value="' . esc_attr($options['idehweb_fortdigital_user']) . '" />
		<p class="description">' . __('enter your Fortdigital pass key', $this->textdomain) . '</p>';
    }


    function setting_fortdigital_password()
    {

        $options = get_option('idehweb_lwp_settings');
        if (!isset($options['idehweb_fortdigital_password'])) $options['idehweb_fortdigital_password'] = '';

        echo '<input type="text" name="idehweb_lwp_settings[idehweb_fortdigital_password]" class="regular-text" value="' . esc_attr($options['idehweb_fortdigital_password']) . '" />
		<p class="description">' . __('enter your Fortdigital pass key', $this->textdomain) . '</p>';
    }

    function setting_fortdigital_sender()
    {

        $options = get_option('idehweb_lwp_settings');
        if (!isset($options['idehweb_fortdigital_sender'])) $options['idehweb_fortdigital_sender'] = '';

        echo '<input type="text" name="idehweb_lwp_settings[idehweb_fortdigital_sender]" class="regular-text" value="' . esc_attr($options['idehweb_fortdigital_sender']) . '" />
		<p class="description">' . __('enter your Fortdigital sender', $this->textdomain) . '</p>';
    }
    ...
    ?>
        <div class="idehweb_phone_number_ccode_wrap">
            <select name="idehweb_lwp_settings[idehweb_phone_number_ccode]" id="idehweb_phone_number_ccode" data-placeholder="<?php _e('Choose a country...', $this->textdomain); ?>">
                <?php
        ...
        ?>
        <button type="button" class="button-primary auth i35" value="<?php _e('Authenticate', $this->textdomain); ?>"><?php _e('activate sms login', $this->textdomain); ?></button>
        <button type="button" class="button-primary activate i34" style="display: none" value="<?php _e('Activate', $this->textdomain); ?>"><?php _e('activate account', $this->textdomain); ?></button>
    ...
    ?>
        ...
        <button type="button" class="button-primary authwithwebsite i35" value="<?php _e('Authenticate', $this->textdomain); ?>"><?php _e('activate sms login', $this->textdomain); ?></button>
    ...
    ?>
        ...
        <div class="creditor">
            <button type="button" class="button-primary loiuyt" value="<?php _e('Check credit', $this->textdomain); ?>"><?php _e('Check credit', $this->textdomain); ?></button>
            <span class="cp"></span>

            <button type="button" class="button-primary refreshShop" value="<?php _e('Refresh', $this->textdomain); ?>"><?php _e('Refresh', $this->textdomain); ?></button>
            <span class="df">
    ...
    function shortcode($atts)
    {
        ...
        ?>
            <a id="show_login" class="show_login" style="display: none" data-sticky="<?php echo esc_attr($options['idehweb_position_form']); ?>"><?php echo __('login', $this->textdomain); ?></a>
            <div class="lwp_forms_login <?php echo esc_attr($class); ?>">
                ...
                ?>
                    <form id="lwp_login" class="ajax-auth" action="login" style="<?php echo $cclass; ?>" method="post">
                        ...
                        <div class="lwp-form-box">
                            <label class="lwp_labels" for="lwp_username"><?php echo __('Phone number', $this->textdomain); ?></label>
                            <?php
                            //                    $country_codes = $this->get_country_code_options();
                            ?>
                            <div class="lwp-form-box-bottom">
                                ...
                                <input type="number" class="required lwp_username the_lwp_input" name="lwp_username" placeholder="<?php echo ($localizationـoptions['idehweb_localization_placeholder_of_phonenumber_field']) ? sanitize_text_field($localizationـoptions['idehweb_localization_placeholder_of_phonenumber_field']) : (__('9*********', $this->textdomain)); ?>">
                            </div>
                        </div>
                        <?php if ($options['idehweb_enable_accept_terms_and_condition'] == '1') { ?>
                            <div class="accept_terms_and_conditions">
                                <input class="required lwp_check_box" type="checkbox" name="lwp_accept_terms" checked="checked">
                ...
                ?>
                    <form id="lwp_login_email" class="ajax-auth" action="loginemail" style="<?php echo $ecclass; ?>" method="post">
                        ...
                        <p class="status"></p>
                        <?php wp_nonce_field('ajax-login-nonce', 'security'); ?>
                        <label class="lwp_labels" for="lwp_email"><?php echo __('Your email:', $this->textdomain); ?></label>
                        <input type="email" class="required lwp_email the_lwp_input" name="lwp_email" placeholder="<?php echo __('Please enter your email', $this->textdomain); ?>">
                        <?php if ($options['idehweb_enable_accept_terms_and_condition'] == '1') { ?>
                            <div class="accept_terms_and_conditions">
                                <input class="required lwp_check_box lwp_accept_terms_email" type="checkbox" name="lwp_accept_terms_email" checked="checked">
                                <span class="accept_terms_and_conditions_text"><?php echo ($options['idehweb_term_and_conditions_text']); ?></span>
                            </div>
                        <?php } ?>
                ...
                <form id="lwp_activate" class="ajax-auth" action="activate" method="post">
                    ...
                    <label class="lwp_labels" for="lwp_scode"><?php echo __('Security code', $this->textdomain); ?></label>
                ...
                ?>
                    <form id="lwp_update_password" class="ajax-auth" action="update_password" method="post">
                        ...
                        <p class="status"></p>
                        <?php wp_nonce_field('ajax-login-nonce', 'security'); ?>
                        <label class="lwp_labels" for="lwp_email"><?php echo __('Enter new password:', $this->textdomain); ?></label>
                        <input type="password" class="required lwp_up_password" name="lwp_up_password" placeholder="<?php echo __('Please choose a password', $this->textdomain); ?>">
                    ...
                    <form id="lwp_enter_password" class="ajax-auth" action="enter_password" method="post">
                        ...
                        <p class="status"></p>
                        <?php wp_nonce_field('ajax-login-nonce', 'security'); ?>
                        <label class="lwp_labels" for="lwp_email"><?php echo __('Your password:', $this->textdomain); ?></label>
                        <input type="password" class="required lwp_auth_password" name="lwp_auth_password" placeholder="<?php echo __('Please enter your password', $this->textdomain); ?>">
...
<?php
    ...
    function send_sms($phone_number, $code)
    {
        ...
        if ($options['idehweb_use_custom_gateway'] == '1') {
            ...
            } else if ($options['idehweb_default_gateways'] == 'fortdigital') {
                $fortdigital = new LWP_Fortdigital_Api();
                return $fortdigital->lwp_send_sms($phone_number, $code);
            } else {
                return true;
            }
        } else {
